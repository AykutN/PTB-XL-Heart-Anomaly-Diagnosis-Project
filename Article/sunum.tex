...
\begin{frame}{Kodlama Ortamı}
	\begin{itemize}
		\item Python ve \texttt{scikit-learn} başta olmak üzere standart makine öğrenmesi kütüphaneleri kullanılmıştır.
		\item Veri işleme, ön işleme hattı ve model eğitim kodları proje deposunda versiyonlanmıştır.
		\item \texttt{pandas}, \texttt{numpy}, \texttt{matplotlib/seaborn}, \texttt{scikit-learn} temel bileşenlerdir.
	\end{itemize}
\end{frame}
