...
\author{\textbf{İstanbul Üniversitesi, Fen Fakültesi, Bilgisayar Bilimleri Bölümü}\\M. Yusuf Aykut\\İbrahim Abu Shawish\\Samet Ertuğrul Kurum\\Samet Baturay}
\date{Aralık 2025}
...
\begin{frame}{Figür 3: Splitlere Göre Sınıf Dağılımı}
	\centering
	\resizebox{0.98\linewidth}{!}{\includegraphics{../reports/data_summary/class_distribution_splits.png}}
\end{frame}
